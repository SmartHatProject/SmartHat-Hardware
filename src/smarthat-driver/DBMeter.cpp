...
DBMeter::DBMeter(int pin, float calibrationDb, int peakRef, int avgRef)
...
float DBMeter::getPeakDB() {
    return _dBSPLPeak;
}

float DBMeter::getAverageDB() {
    return _dBSPLAvg;
}

int DBMeter::readSensor() {
